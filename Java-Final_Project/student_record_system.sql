...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2022 at 08:05 AM
...
INSERT INTO `student_info` (`studentId`, `studentName`, `dateOfBirth`, `age`, `address`, `status`, `emailAddress`, `contactNumber`, `emergencyName`, `emergencyNumber`, `courseId`, `academicId`, `gradesId`) VALUES
(2, 'Lorgem', '2022-11-12', 22, 'Samjung', 'Single', 'lorgem@gmail.com', 98765432144, 'Bosque', 94613254876, 1, 1, 1),
(3, 'Oms', '2022-12-06', 11, 'Samjung', 'Single', 'oms@gmail.com', 97845125687, 'Pelingon', 94567849123, 1, 1, 1),
(5, 'jean', '2022-11-12', 22, 'Samjung', 'Single', 'oms@gmail.com', 94258888522, 'omms', 94513250815, 1, 1, 2),
(6, 'chem', '2022-12-20', 13, 'can-avid', 'single', 'che@gmail.com', 97257575746, 'Cosme', 90004512641, 5, 5, 2);
...
ALTER TABLE `student_info`
  ...
  ADD KEY `courseId` (`courseId`,`academicId`,`gradesId`),
...
ALTER TABLE `student_info`
  ...
  ADD CONSTRAINT `student_info_ibfk_2` FOREIGN KEY (`gradesId`) REFERENCES `student_grades` (`gradesId`),
