        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (rs.getString(4).equals("1")) {
                    String additionalSecurity = "SELECT emailAddress FROM admin_info WHERE userId = ?";
                    ...
                    String studentInfo = "SELECT student_info.studentName, student_info.teacherId FROM student_info INNER JOIN users_info ON student_info.usersId = users_info.userId WHERE student_info.usersId = ?";
