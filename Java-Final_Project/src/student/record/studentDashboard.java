...
public final class studentDashboard extends javax.swing.JFrame {
    ...
    private void users_update(){
        ...
        String query = "SELECT tblcourses.courseCode, tblcourses.courseDescription, tblcourses.courseUnit, student_grades.MG, student_grades.FG "
                            + "FROM student_account_table INNER JOIN tblcourses ON student_account_table.courseId = tblcourses.courseId "
                            + "INNER JOIN student_grades ON student_account_table.gradesId = student_grades.gradesId "
                            + "WHERE student_account_table.userId = ?";
        try {
    ...
    public void display_personal_information(){
        ...
        ResultSet rs;
        String i = id.getText();
        String query = "SELECT student_info.studentName, student_info.dateOfBirth, student_info.age, student_info.address, student_info.status,tblcourses.courseCode, academic_level.academicName, student_info.emailAddress, student_info.contactNumber, student_info.emergencyName, student_info.emergencyNumber FROM student_account_table INNER JOIN student_info ON student_account_table.studentId = student_info.studentId INNER JOIN academic_level ON student_account_table.academicId = academic_level.academicId INNER JOIN tblcourses ON student_account_table.courseId = tblcourses.courseId WHERE student_account_table.userId = ?";
        try {
            ps = StudentRecord.getConnection().prepareStatement(query);
            ps.setString(1, i);
            rs = ps.executeQuery();
    ...
    private void initComponents() {
        ...
        contactNumber1.setText("Emergency Name");
        ...
        contactNumber2.setText("Emergency Number");
                ...
                .addGroup(jpanelBlueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jpanelBlueLayout.createSequentialGroup()
                        .addGroup(jpanelBlueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(contactNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jpanelBlueLayout.createSequentialGroup()
                        .addGroup(jpanelBlueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jpanelBlueLayout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(contactNumber1, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(contactNumber2))
                        .addGroup(jpanelBlueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jpanelBlueLayout.createSequentialGroup()
                                .addGap(7, 7, 7)
                                .addGroup(jpanelBlueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(emergencyName, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(contactNumbeR, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jpanelBlueLayout.createSequentialGroup()
                                .addGap(32, 32, 32)
                                .addComponent(emergencyNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addGap(38, 38, 38))
            .addGroup(jpanelBlueLayout.createSequentialGroup()
                .addGap(66, 66, 66)
